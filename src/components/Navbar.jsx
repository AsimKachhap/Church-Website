        ...
        <div>
          <a href="#how-to-reach">
            <button className=" relative cursor-pointer ">
              <div className="px-2 py-[6px]  uppercase text-[10px] bg-accent  font-medium tracking-tight  relative group transition duration-200 text-text-primary active:scale-95 active:translate-y-1 ">
                How to Reach
              </div>
            </button>
          </a>
        ...
        <div>
          <a href="#how-to-reach">
            <button className="p-[3px] relative cursor-pointer ">
              <div className="px-4 py-2  uppercase bg-accent  relative group transition duration-200 text-text-primary hover:bg-accent shadow-md  hover:scale-105 hover:-translate-y-1  ">
                How to Reach
              </div>
            </button>
          </a>
