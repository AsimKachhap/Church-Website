...
const Navbar = () => {
  return (
    <>
      <div className=" md:hidden sticky  top-0 flex justify-center items-center  bg-indigo-200 border border-indigo-700 backdrop-blur-md px-4 p-2 text-indigo-700 ">
